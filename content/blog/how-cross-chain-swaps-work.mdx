...
faq:
  ...
  - question: "Can I swap between two EVM chains, not just Solana and an EVM chain?"
    answer: "Yes. An EVM chain swap here — for example Ethereum to Base, or Base to Arbitrum — skips the Solana leg entirely and routes directly through Relay's cross-chain leg, since both sides are already EVM. Same quote-then-sign flow, same flat 0.25% fee, one less leg than a Solana-origin swap."
---
